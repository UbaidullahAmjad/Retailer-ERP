    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class=""><?php echo e(trans('file.Sales Estimate List')); ?></h3>
            </div>
        ...
        <table id="sale-table" class="table sale-list" style="width: 100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php if($sale->payment_method == 1): ?>
                    <td><?php echo e(trans('file.white Cash')); ?></td>
                    <?php elseif($sale->payment_method == 2): ?>
                    <td><?php echo e(trans('file.Black Cash')); ?></td>
                    <?php else: ?>
                    <td></td>
                    <?php endif; ?>
                    <?php if($sale->estimate_type == 0): ?>
                    <td><div class="btn-group">
                            <button type="button" class="btn btn-sm dropdown-toggle btn-primary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(trans('file.Created')); ?>
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                <a class="btn btn-link" href="<?php echo e(route('sales.cancelEstimate',$sale->id)); ?>"><?php echo e(trans('file.Cancel')); ?></a>
                                </li>
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('sales.acceptEstimate',$sale->id)); ?>"> <?php echo e(trans('file.Accept')); ?></a>
                                </li>
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('sales.negotiateEstimate',$sale->id)); ?>"> <?php echo e(trans('file.Negotiate')); ?></a>
                                </li>
                                
                            </ul>
                        </div></td>
                    <?php elseif($sale->estimate_type == 1): ?>
                    <td><div class="btn-group">
                            <button type="button" class="btn btn-sm dropdown-toggle btn-secondary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(trans('file.Negotiation')); ?>
                    ...
                    <?php elseif($sale->estimate_type == 2): ?>
                    <td><div class="btn-group">
                            <button type="button" class="btn btn-sm dropdown-toggle btn-danger" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(trans('file.Cancelled')); ?>
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                <a class="btn btn-link" href="<?php echo e(route('sales.reactivateEstimate',$sale->id)); ?>"><?php echo e(trans('file.Reactivate')); ?></a>
                                </li>
                            </ul>
                        </div></td>
                    <?php else: ?>
                    <td><div class="btn-group">
                            <button type="button" class="btn btn-sm dropdown-toggle btn-success" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(trans('file.Accepted')); ?>
                    ...
                    <?php endif; ?>
                    <td>
                        <a class="btn" href="<?php echo e(route('sales.edit',$sale->id)); ?>"><i class="dripicons-document-edit"></i></a>
                        <a class="btn" href="<?php echo e(route('sales.generatePreInvoicePDF', $sale->id)); ?>"><i class="fa fa-file-pdf-o"></i></a>
                        <a class="btn" href="<?php echo e(route('sales.approveEstimate',$sale->id)); ?>"><i class="fa fa-eye"></i></a>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <!-- <li>
                                <a class="btn btn-link" href="<?php echo e(route('sales.reactivateEstimate',$sale->id)); ?>"><?php echo e(trans('file.order')); ?></a>
                                </li> -->
                                <li>
                                <a class="btn btn-link" href="<?php echo e(route('sales.reactivateEstimate',$sale->id)); ?>"><?php echo e(trans('file.Delivery Slip')); ?></a>
                                </li>
                                <li>
                                <a class="btn btn-link" href="<?php echo e(route('sales.createSaleInvoice',$sale->id)); ?>"><?php echo e(trans('file.Invoice')); ?></a>
                                </li>
                            </ul>
                        </div>
                    </td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ERP\resources\views/sale/index.blade.php ENDPATH**/ ?>