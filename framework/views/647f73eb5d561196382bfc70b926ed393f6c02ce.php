      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            ...
            <?php endif; ?>
            <?php if($message = Session::get('error1')): ?>
                                        <div class="alert alert-danger">
                                            <p><?php echo e($message); ?></p>
                                        </div>
                                    <?php endif; ?>
            <?php if(Session::has('message')): ?>
            <p class="bg-danger text-white p-2 rounded"><?php echo e(Session::get('message')); ?></p>
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('do-login')); ?>" id="login-form">
              <?php echo csrf_field(); ?>
