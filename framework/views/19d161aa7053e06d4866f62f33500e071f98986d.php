 <?php $__env->startSection('content'); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label><?php echo e(trans('file.Manufacturers')); ?></label>
                                                <select name="manufacture_id" id="manufacture_id"
                                                    class="selectpicker form-control" data-live-search="true"
                                                    data-live-search-style="begins" title="Select Manufacturer..."
                                                    data-href="<?php echo e(route('get_models_by_manufacturer')); ?>">
                                                    <?php $__currentLoopData = $manufacturers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manufacturer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($manufacturer->manuId); ?>">
                                                            <?php echo e($manufacturer->manuName); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="model_id"><?php echo e(__('Select Model')); ?></label>
                                                <select name="model_id" id="model_id"
                                                    data-href="<?php echo e(route('get_engines_by_model')); ?>" class="form-control"
                                                    required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="engine_id"><?php echo e(__('Select Engine')); ?></label>
                                                <select name="engine_id" id="engine_id"
                                                    data-href="<?php echo e(route('get_sections_by_engine')); ?>" class="form-control"
                                                    required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="section_id" id="section_id"
                                                    data-href="<?php echo e(route('get_section_parts')); ?>" class="form-control"
                                                    required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="section_part_id"><?php echo e(__('Select Section Part')); ?></label>
                                                <select name="section_part_id" id="section_part_id"
                                                    data-href="<?php echo e(route('get_brands_by_section_part')); ?>"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="recieved-product-qty d-none">
                                                                <?php echo e(trans('file.Recieved')); ?></th>
    ...
    <script type="text/javascript">
                    ...
                    $(".product-code").each(function(i) {
                        if ($(this).val() == data[1]) {
                            ...
                            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ') .qty').val(
                                qty);
                            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ') .recieved')
                                .val(qty);
        ...
        function getSectionParts(url, section_id) {
            $.get(url + '?section_id=' + section_id, function(data) {
                ...
                $.each(response, function(key, value) {
                    view_html +=
                        `<option value="${value.legacyArticleId}">${value.genericArticleDescription +"-"+value.articleNumber}</option>`;
                });
                console.log(data, view_html);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ERP\resources\views/purchase/create.blade.php ENDPATH**/ ?>