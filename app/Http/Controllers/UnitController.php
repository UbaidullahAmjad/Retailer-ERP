...
class UnitController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $unit_name_unit = Unit::where('unit_name',$input['unit_name'])->first();
        $unit_code_unit = Unit::where('unit_code',$input['unit_code'])->first();
        if($unit_name_unit && $unit_name_unit->unit_name != $lims_unit_data->unit_name){
            toastr()->error('Unit Name has been taken already');
            return redirect()->back();
        }

        if($unit_code_unit && $unit_code_unit->unit_code != $lims_unit_data->unit_code){
            toastr()->error('Unit Code has been taken already');
            return redirect()->back();
        }
