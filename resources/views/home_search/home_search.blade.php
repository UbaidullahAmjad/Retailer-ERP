    ...
    <section>
        ...
        <div class="container-fluid">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-content manufacturer_content form-control">
                                                    <input type="text" placeholder="Select by Manufacture" id="manufacturer_input_search"
                                                    ...
                                                    <div class="manufacturer_normal_option">
                                                        @foreach ($manufacturers as $manufacturer)
                                                            <div class="manufacturer_option"
                                                                ...
                                                                {{ $manufacturer->linkingTargetType . "-" . $manufacturer->manuName }}
                                                            </div>
                                                        @endforeach
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-content model_content form-control">
                                                    <input type="text" placeholder="Select by Model " id="model_input_search"
                                                        onkeyup="filterModel()">
                                                        <span style="display: none;" id="model_searching">Searching <span class="loading"></span></span>
                                                    <div class="model_normal_option">

                                                    </div>
                                                    <div class="more model_more" id="model_more" style="display:none;"> <span>Load More
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-content engine_content form-control">
                                                    <input type="text" placeholder="search by Engine" id="engine_input_search"
                                                    ...
                                                    <div class="more engine_more" id="engine_more" style="display:none;"> <span>Load More
                                                            &nbsp;&nbsp;<span> <span style="display:none;"
                                ...
                                <div class="row">
                                    <div class="col text-right">
                                        <button class="btn btn-primary" type="submit" onclick="removeData()" ><i
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-content product_group_content form-control">
                                                    ...
                                                    {{-- @if ($brands_count > 10) --}}
                                                    <div class="more product_group_more" style="display:none" id="section_more"><span>Load More
                                                        &nbsp;&nbsp;<span> <span style="display:none;"
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('search_sections_by_engine') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="plate_engine_id" id="platee_engine_id" readonly>
                                    <input type="hidden" class="form-control" name="plate" value="1" readonly>
                ...
                <!-- <div class="div">
                    <form action="{{ url('exportData') }}" enctype="multipart/form-data" method="post">
                        @csrf
