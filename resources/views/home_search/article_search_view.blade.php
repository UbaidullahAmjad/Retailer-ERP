                                                ...
                                                <table class="table-responsive">
                                                    <tbody class="article_search_view_scroll">
                                                        ...
                                                        <tr class="article_table_row article_table_row_style">
                                                            ...
                                                            <td>
                                                                @if(file_exists(public_path('/images/articles/'.$section_part->articleNumber .'.jpg')))
                                                                <img src="/images/articles/{{$section_part->articleNumber. '.jpg'}}" alt="">
                                                                @else
                                                                <img class="back_article_image" src="{{ asset('/images/50.jpg')}}" alt="">
                                                                @endif
                                                            </td>
                                                            ...
                                                            <td style="width: 100%">
                                                                <a class="btn btn-primary text-white" href="{{route('articles_view',[$section_part->legacyArticleId,$engine->linkageTargetId,$section_id,$ga->articleId])}}"><i class="fa fa-eye"></i></a>
                                                            </td>
                                                        </tr>
                                                        @endforeach
