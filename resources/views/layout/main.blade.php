...
@php ini_set('max_execution_time', 10000000); @endphp
    ...
    @if ($FormUser != null)
        ...
        <nav class="side-navbar">
            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                @if ($sale_index_permission_active ||
                    ...
                    <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i
                        ...
                        <ul id="sale" class="collapse list-unstyled ">
                            ...
                            <li id="pre-invoices-list-menu"><a
                                    href="{{ route('delivery_slips') }}">{{ trans('file.Delivery Slips') }}</a>
                            </li>
                ...
                <li id="supplier-list-menu" class="{{ $route == 'supplier.create' ? 'active' : '' }}"><a
                        href="{{ route('supplier.create') }}"><i class="dripicons-user-group"></i>
                        {{ trans('file.Suppliers') }}</a></li>
                <li><a href="#accounting" aria-expanded="false" data-toggle="collapse"> <i
                            class="fa fa-dollar"></i><span>{{ trans('file.Accounting') }}</span></a>
                    <ul id="accounting" class="collapse list-unstyled ">
                        <li id="accounting-list-menu" class="{{ $route == 'cash.management' ? 'active' : '' }}"><a
                                href="{{ route('cash.management') }}">{{ trans('file.Cash Management') }}</a></li>
                        <li id="accounting-list-menu" class="{{ $route == 'cash.management' ? 'active' : '' }}"><a
                                href="{{ route('bank_account.index') }}">{{ trans('file.Bank Account') }}</a></li>
                        <li id="accounting-list-menu"
                            class="{{ $route == 'cash.management.cheque' ? 'active' : '' }}"><a
                                href="{{ route('cash.management.cheque') }}">
                                {{ trans('file.Check And Drafts') }}</a></li>
                    </ul>
                </li>
                ...
                @if ($index_permission_active)
                    ...
                    <ul id="quotation" class="collapse list-unstyled ">
                        <li id="quotation-list-menu"><a
                                href="{{ route('quotations.index') }}">{{ trans('file.Estimate List') }}</a></li>
                        <li id=""><a
                                href="{{ route('preinvoices.index') }}">{{ trans('file.Pre Invoice List') }}</a>
                        </li>
                        <li id=""><a
                                href="{{ route('invoices.index') }}">{{ trans('file.Invoice List') }}</a></li>
                    </ul>
                    </li>
                @endif
                <?php
                ...
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    @if ($discount_permission_active)
                        <li id="discount-list-menu"><a
                                href="{{ route('discounts.index') }}">{{ trans('file.Discount') }}</a>
                        </li>
                    @endif
            ...
            <header class="container-fluid">
                <nav class="navbar">
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <li class="nav-item"><a href="{{ route('cart') }}" data-toggle="tooltip" title=""
                            class="nav-link dropdown-item"><i class="fa fa-shopping-cart"></i><span
                                class="badge badge-danger notification-number">{{ count($cart_items) }}</span>
                        </a>
                        </li>
                        @else
                        <li class="nav-item"><a href="#" data-toggle="tooltip" title="Your Cart is Empty"
                            class="nav-link dropdown-item"><i class="fa fa-shopping-cart"></i><span
                                class="badge badge-danger notification-number">{{ count($cart_items) }}</span>
                        </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a rel="nofollow" data-toggle="tooltip" title="{{ __('Notifications') }}"
                                class="nav-link dropdown-item"><i class="dripicons-bell"></i><span
                                    class="badge badge-danger notification-number">{{ count(\Auth::user()->unreadNotifications) > 0 ? count(\Auth::user()->unreadNotifications) : '' }}</span>
                            </a>
                            @php
                            ...
                            <ul class="right-sidebar" id="notify">
                                @foreach ($user_notifications as $noti)
                                    @if ($noti->noti_type == 'formapprove' && $noti->read_at == null)
                                        <li style="background-color: lightgrey"><a
                                                href="{{ url('approved_dashboard', $noti->id) }}">{{ Str::limit($noti->data['message'], 30) }}</a>
                                        </li>
                                    ...
                                    @elseif(isset($noti->data['type']) && $noti->data['type'] == 'rejected' && $noti->read_at != null)
                                        <li style="background-color: white">
                                            <a href="{{ url('/' . $noti->data['file_name']) }}"> Import CSV rejected
                                                Items</a>
                                            {{-- <span style="font-size: 12px; display:flex; justify-content: end"> {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $noti->created_at) }}</span> --}}
                                        </li>
                                    @endif
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 id="exampleModalLabel" class="modal-title">{{ trans('file.Send Notification') }}
                            </h5>
